...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-gray-800 text-gray-300 py-2 px-2'>
      <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 py-8 px-4 border-b-2 border-gray-600'>
        <div>
            <h6 className='font-bold uppercase pt-2 className="py-1"'>Solutions</h6>
            <ul>
      ...
      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4'>2022 Trvl, LLC. All rights reserved</p>
